...
// register read event, open EPOLLONESHOT
...
void http_conn::process()
{
    ...
    if (read_ret == NO_REQUEST) {
        modFd(h_epoll_fd, m_sockfd, EPOLLIN, m_TRIGMode);
        return;
    }
    ...
    modFd(h_epoll_fd, m_sockfd, EPOLLOUT, m_TRIGMode);
}
